...
# =============================================================================
DATA_DIR   = r'D:/bulk-download/GSE182434/cellcomm'   # CSV 数据所在目录
OUTPUT_DIR = r'D:/bulk-download/GSE182434/cellcomm'   # 图片输出目录（可改为其他路径）
os.makedirs(OUTPUT_DIR, exist_ok=True)

VOLCANO_CSV = r'D:/bulk-download/GSE182434/cellcomm/volcano_data_malignant_vs_normal_monomac.csv'
...
P06 = {
    ...
    # ── 标注点选择 ────────────────────────────────────────────────────────────
    "n_label_mal_top"         : 10,       # Malignant-enriched，Delta 最大前 N 个
    "n_label_nor_top"         : 10,       # Normal-enriched，Delta 最小前 N 个
...
#  ① 路径 & 全局参数
# =============================================================================
DATA_DIR   = r'D:/bulk-download/GSE182434/cellcomm'
OUTPUT_DIR = r'D:/bulk-download/GSE182434/cellcomm'
os.makedirs(OUTPUT_DIR, exist_ok=True)
...
# ══════════════════════════════════════════════════════════════════════════════
DATA_DIR_7   = r'D:/bulk-download/GSE182434'
...
#  ① 路径 & 全局参数
# =============================================================================
DATA_DIR   = r'D:/bulk-download/GSE182434/cellcomm'   # CSV 数据目录
OUTPUT_DIR = r'D:/bulk-download/GSE182434/cellcomm'   # 图片输出目录
os.makedirs(OUTPUT_DIR, exist_ok=True)
...
# ── 路径 ─────────────────────────────────────────────────────────────────────
DATA_DIR = r'D:\bulk-download\GSE182434'
OUT_DIR  = DATA_DIR
DPI      = 150
