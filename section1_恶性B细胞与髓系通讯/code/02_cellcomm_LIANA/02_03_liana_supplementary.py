...
full = pd.read_csv(translate(r"D:\bulk-download\GSE182434\cellcomm\liana_results_full.csv"))
...
relaxed.to_csv(translate(r"D:\bulk-download\GSE182434\cellcomm\liana_top20_under_0.1.csv"), index=False)
print("\n已存: liana_top20_under_0.1.csv")

import pandas as pd

full7 = pd.read_csv(translate(r"D:\bulk-download\GSE182434\cellcomm\liana_results_full.csv"))
full13 = pd.read_csv(translate(r"D:\bulk-download\GSE182434\cellcomm\liana_results_13subtypes_full.csv"))
...
mac.to_csv(translate(r"D:\bulk-download\GSE182434\cellcomm\TableS24_BtoMac_ranking_sensitivity.csv"),
           index=False)
...
df = pd.read_csv(translate(r"D:\bulk-download\GSE182434\cellcomm\TableS24_BtoMac_ranking_sensitivity.csv"))
...
out.to_csv(translate(r"D:\bulk-download\GSE182434\cellcomm\TableS24_clean.csv"), index=False)
