...
md = pd.read_csv(translate(r"D:\bulk-download\GSE182434\cell_metadata.csv"))
print(md.columns.tolist())
print(md.head(3))

# 2) 检查 h5ad 的 obs
import scanpy as sc
adata = sc.read_h5ad(translate(r"D:\bulk-download\GSE182434\adata_processed.h5ad"), backed="r")
...
ct_main.to_csv(translate(r"D:\bulk-download\GSE182434\ARI_crosstab_CellType_vs_leiden06.csv"))
ct_sub.to_csv(translate(r"D:\bulk-download\GSE182434\ARI_crosstab_CellType_vs_celltype.csv"))
...
sheet_a.to_csv(str(OUT) + r"\TableS23a_crosstab_CellType_vs_leiden06.csv")
print(sheet_a)
...
ct_b.to_csv(str(OUT) + r"\TableS23b_crosstab_CellType_vs_celltype.csv")
...
sheet_c.to_csv(str(OUT) + r"\TableS23c_persample_ARI.csv", index=False)
...
sheet_d.to_csv(str(OUT) + r"\TableS23d_resolution_sensitivity.csv", index=False)
