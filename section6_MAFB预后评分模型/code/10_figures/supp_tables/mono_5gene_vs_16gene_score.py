...
# 侦察1：16基因评分文件结构
latam = pd.read_csv(r'D:\bulk-download\GSE232853_v2\fig4_paired_ROI_16gene_LATAM.csv')
print(latam.columns.tolist())
print(latam.head(3))
print('行数:', len(latam))

# 侦察2：meta注释结构（确认compartment/tissue列名）
meta = pd.read_csv(r'D:\bulk-download\GSE232853_v2\meta_df.csv', index_col=0)
print(meta.columns.tolist())

# 侦察3：Q3矩阵结构
expr = pd.read_csv(r'D:\bulk-download\GSE232853_v2\expression_q3_lognorm.csv', index_col=0, nrows=5)
...
# ---------- 1) 读入 + 转置 ----------
latam = pd.read_csv(r'D:\bulk-download\GSE232853_v2\fig4_paired_ROI_16gene_LATAM.csv')
expr  = pd.read_csv(r'D:\bulk-download\GSE232853_v2\expression_q3_lognorm.csv', index_col=0)
